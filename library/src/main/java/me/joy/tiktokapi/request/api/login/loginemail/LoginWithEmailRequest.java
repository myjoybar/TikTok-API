 ...
 */
public class LoginWithEmailRequest extends TTBasePostRequest<LoginResponseData> {

  private String email="";
  private String password ="";
  private String captcha ="";

  public LoginWithEmailRequest(String email, String password, String captcha) {
    this.email = email;
